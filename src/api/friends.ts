...
export class M1ApiFriends extends M1ApiBase {
	...
	getRequests({
		...
		ApiResponse<ResponseFriendsGetRequests | ResponseFriendsGetRequestsShort>
	> {
	 ...
	 * @returns A list of friends and their count.
	 */
	get<const OS extends boolean, const OU extends boolean>(
	...
	get<const OS extends boolean, const OU extends boolean>(
		...
		const user_id =
			typeof arg0 === 'number' || typeof arg0 === 'string' ? arg0 : undefined;
