import { array, boolean, literal, nullable, number, object, optional, pipe, string, transform, union, record, unknown, picklist, } from 'valibot';
...
export const valiObjectThingPrototypeSchema = object({
    ...
    title: string(),
    description: string(),
    group: optional(pipe(nullable(number()), transform((value) => (typeof value === 'number' ? value : undefined)))),
    quality: number(),
